...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('admin-lte/assets/img/AdminLTELogo.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('admin-lte/assets/img/AdminLTELogo.png') }}">
