    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <div class="mb-3">
                        <label for="account_number" class="form-label">Nomor Akun (opsional)</label>
            ...
            <button onclick="confirm('Simpan perubahan akun kas?')||event.stopImmediatePropagation()"
                wire:click="save" class="btn btn-dark text-inv-primary">Simpan Perubahan</button>
        </div>
    </div>
</div>
