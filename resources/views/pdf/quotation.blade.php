...
<body>
    <div class="container">
        ...
        <div class="details">
            <div>
                <h3>Detail Klien</h3>
                <p><strong>Nama:</strong> {{ $quotation->client_name ?? $quotation->client?->name ?? '-' }}</p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong>Rp {{ number_format(round($quotation->subtotal ?? 0), 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align:right"><strong>PPN ({{ number_format($quotation->tax_percentage ?? 0, 0) }}%)</strong></td>
                    <td><strong>Rp {{ number_format(round($quotation->tax_amount ?? 0), 0, ',', '.') }}</strong></td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align:right"><strong>Grand Total</strong></td>
                    <td><strong>Rp {{ number_format(round($quotation->grand_total ?? $quotation->total_amount ?? 0), 0, ',', '.') }}</strong></td>
                </tr>
            </tbody>
        </table>
